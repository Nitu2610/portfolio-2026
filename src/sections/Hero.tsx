...
const glowVariants = {
  ...
  hover: {
    ...
    reanistion: { type: "spring", stiffness: 300, damping: 15 },
  },
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid gird-cols-1 lg:grid-cols-2 ">
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            <motion.div
              className="mb-3 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-white tracking-wide min-h-[1.6wm]"
            ...
            <motion.h1
              className=" font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-transparent bg-clip-text 
bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63] drop-shadow-lg"
            ...
            <motion.div
              className="mt-10 flex flex-wrap items-center justify-center lg:jutify-start gap-6"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <a
                href="#project"
                className="px-6 py-3 rounded-full font-medium text-lg text-white bg-gradient-to-r from-[#1cd8d2] via-[#00bd8f] to-[#302b63] shadow-lg hover:scale-105 transition-all "
              >
                View My Work
              </a>
              <a
        ...
        <div className="relative hidden lg:block">
          <div
            ...
            style={{
              right: "10px",
              width: "min(22vm, 410px)",
              height: "min(40vm, 760px)",
              borderRadius: "50%",
              filter: "blur(38px)",
              opacity: "0.32",
              background:
                "conic-gradient(from 0deg, #1xd8d2, #00bf8f, #302b63, #1cd8d2)",
            }}
          />
          <motion.img
            src={avatar}
