...
export const About = () => {
  const stats = [
    { label: "IT Experience", value: "5+ years" },
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6  md:px-10 lg:px-12 py-20 flex flex-col gap-12 ">
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relax text-base sm:text-lg max-w-2xl md:max-w-3xl">
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 max-w-3xl  ">
              {stats.map((item, i) => (
                <motion.div
                  key={i}
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
              <a
                href="#projects"
                className="inline-flex items-center justify-center rounded-lg bg-white text-black font-semibold px-5 py-3 hover:bg-gray-200 tranistion "
              >
                View Project
              </a>
              <a
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
            I'm a Full-Stack Developer with 5+ years of experience in IT,
            combining a strong quality mindset with hands-on experience building
            modern web applications using React, TypeScript, Node.js, Express,
            and MongoDB.
          </p>
          <p className="mt-4 text-gray-400 text-base sm:text-lg">
            I enjoy turning real-world requirements and business rules into
            scalable, maintainable, and user-friendly products, while focusing
            on clean architecture, problem solving, and continuous learning.
          </p>
        </motion.div>
      </div>
    </section>
